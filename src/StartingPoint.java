...
public class StartingPoint extends Applet implements Runnable, MouseListener{
     ...
     *
     * TODO: Generate pairs for subtraction
     *
     ...
     *
     * TODO: Fix dimension checks for area of hit "circles"
    ...
    public void mouseClicked(MouseEvent e) {
        for (Fly f : flies) {
            ...
            if (xPos >= fX - fR && xPos <= fX + fR  && yPos >= fY - fR && yPos <= fY + fR) {
                f.setFlyClick(true);
            }
        }
    }
